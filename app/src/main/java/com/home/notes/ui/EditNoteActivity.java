...
public class EditNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.fragment_edit_title);
        description = findViewById(R.id.fragment_edit_description);
        updateNote = findViewById(R.id.fragment_update_note_button);
